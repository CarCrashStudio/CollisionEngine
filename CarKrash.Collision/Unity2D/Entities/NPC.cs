...
namespace CarKrash.Collision.Unity2D
{
    ...
    public abstract class NPC : MonoBehaviour, IInteractable<GameObject>, ICanWalk
    {
        ...
        public void OnInteractableEnter(IInteracter<GameObject> interacter)
        {
        ...
        public void OnInteractableExit(IInteracter<GameObject> interacter)
        {
            Debug.Log(interacter);
            if (interacter == null) { return; }
        ...
        private void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            {
                OnInteractableEnter(collision.GetComponent<IInteracter<GameObject>>());
            }
        }
        private void OnTriggerExit2D(Collider2D collision)
        {
            ...
            {
                // do something
                OnInteractableExit(collision.GetComponent<IInteracter<GameObject>>());
            }
        }
