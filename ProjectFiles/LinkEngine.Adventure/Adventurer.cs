...
namespace LinkEngine.Adventure
{
    ...
    public class Adventurer : Player
    {
            ...
            base(_id, _name, _clss.HP, _clss.HP)
        {
            ...
            StrengthModifiers = new List<Modifier>();
            PerceptionModifiers = new List<Modifier>();
            EnduranceModifiers = new List<Modifier>();
            CharismaModifiers = new List<Modifier>();
            IntelligenceModifiers = new List<Modifier>();
            AgilityModifiers = new List<Modifier>();
            LuckModifiers = new List<Modifier>();
        }
